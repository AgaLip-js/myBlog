    ...
    <StyledWrapper>
        <article>
            ...
            <p>
                ...
                <strong> zasady zapisywania i uzyskiwania dostępu do danych na Urządzeniach Użytkowników</strong>
                {' '}
            ...
            <ul>
                <li>
                    <p>
                        ...
                        {' '}
                        - serwis internetowy Zakoduj to działający pod adresem https://zakoduj-to.pl
                    </p>
                </li>
                {' '}
                <li>
                    <p>
                        <strong>Serwis zewnętrzny</strong>
                        {' '}
                ...
                <li>
                    <p>
                        ...
                        {' '}
                        - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest Agata Lipiak prowadząca działalnośc gospodarczą pod firmą Agata Lipiak - Zakoduj to ul. Jędrzychowice 77, 59-900 Zgorzelec NIP: 6152063512, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu
                    </p>
                </li>
                {' '}
                <li>
                    <p>
                        ...
                        {' '}
                        - osoba fizyczna, dla której Administrator świadczy usługi drogą elektroniczną za pośrednictwem Serwisu.
                    </p>
                </li>
                {' '}
                <li>
                    <p>
                        ...
                        {' '}
                        - elektroniczne urządzenie wraz z oprogramowaniem, za pośrednictwem którego Użytkownik uzyskuje dostęp do Serwisu
                    </p>
                </li>
                {' '}
                <li>
                ...
                <li>
                    <p>
                        <strong>Ograniczenie przetwarzania</strong>
                        {' '}
            ...
            <ul>
                <li>
                    <p>
                        <strong>Cookies wewnętrzne</strong>
                        {' '}
                ...
                <li>
                    <p>
                        <strong>Cookies zewnętrzne</strong>
                        {' '}
                        - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez systemy teleinformatyczne Serwisów zewnętrznych. Skrypty Serwisów zewnętrznych, które mogą umieszczać pliki Cookies na Urządzeniach Użytkownika zostały świadomie umieszczone w Serwisie poprzez skrypty i usługi udostępnione i zainstalowane w Serwisie
                        {' '}
                    </p>
                </li>
                {' '}
                ...
                <li>
                    <p>
                        ...
                        {' '}
                        do momentu ich ręcznego usunięcia. Pliki nie są usuwane automatycznie po zakończeniu sesji Urządzenia chyba że konfiguracja Urządzenia Użytkownika jest ustawiona na tryb usuwanie plików Cookie po zakończeniu sesji Urządzenia.
                    </p>
                </li>
            </ul>
            <h2 style={{
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Cookie wewnętrzne</strong>
                        {' '}
                        - zastosowane przez Administratora pliki Cookie są bezpieczne dla Urządzeń Użytkowników i nie zawierają skryptów, treści lub informacji mogących zagrażać bezpieczeństwu danych osobowych lub bezpieczeństwu Urządzenia z którego korzysta Użytkownik.
                    </p>
                </li>
                {' '}
                <li>
                    <p>
                        <strong>Cookie zewnętrzne</strong>
                        {' '}
                        - Administrator dokonuje wszelkich możliwych działań w celu weryfikacji i doboru partnerów serwisu w kontekście bezpieczeństwa Użytkowników. Administrator do współpracy dobiera znanych, dużych partnerów o globalnym zaufaniu społecznym. Nie posiada on jednak pełnej kontroli nad zawartością plików Cookie pochodzących od zewnętrznych partnerów. Za bezpieczeństwo plików Cookie, ich zawartość oraz zgodne z licencją wykorzystanie przez zainstalowane w serwisie Skrypty, pochodzących z Serwisów zewnętrznych, Administrator nie ponosi odpowiedzialności na tyle na ile pozwala na to prawo. Lista partnerów zamieszczona jest w dalszej części Polityki Prywatności.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        ...
                        {' '}
                        <a rel="external" href="https://nety.pl/cyberbezpieczenstwo/">zasad korzystania z sieci internet</a>
                        .
                    </p>
                </li>
                <li>
            ...
            <ul id="zewnetrzne">
                <li>
                    ...
                    <br />
                    <ul><li><a rel="nofollow external" href="https://www.facebook.com/legal/terms">Facebook</a></li></ul>
                </li>
                <li>
                    <strong>Prowadzenie statystyk:</strong>
                    <ul><li><a rel="nofollow external" href="https://policies.google.com/privacy?hl=pl">Google Analytics</a></li></ul>
                </li>
            </ul>
            ...
            <ul><li>Firmy hostingowe, świadczące usługi hostingu lub usług pokrewnych dla Administratora</li></ul>
            <p><strong>Powierzenie przetwarzania danych osobowych - Usługi Hostingu, VPS lub Serwerów Dedykowanych</strong></p>
            <p>
                Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych -
                <strong><a rel="nofollow external" href="https://static.nazwa.pl/regulaminy/Pl_prywatnosci.pdf?_ga=2.162683195.647960140.1615142284-1062267713.1610744254&_gac=1.215389413.1613653737.Cj0KCQiAvbiBBhD-ARIsAGM48bwCx4Ugqop0j-kgOzWRELF2kK-bo3llKD5H6Wk-1QVxBxrFB1UHprMaAk9QEALw_wcB">nazwa.pl</a></strong>

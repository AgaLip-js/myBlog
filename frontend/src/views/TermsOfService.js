        ...
        <article>
            ...
            <ul>
                ...
                <li>
                    ...
                    {' '}
                    – serwis internetowych &quot;Zakoduj to&quot;, działających pod adresem https://zakoduj-to.pl
                </li>
                <li>
                    <strong>Usługodawca</strong>
                    {' '}
                    – firma Agata Lipiak - Zakoduj to z adresem siedziby ul. Jędrzychowice 77, 59-900 Zgorzelec, NIP: 6152063512
                    <li>
                        <strong>Usługobiorca</strong>
                        {' '}
                        – każda osoba fizyczna, uzyskująca dostęp do Serwisu i korzystająca z usług świadczonych za pośrednictwem Serwisu przez Usługodawcę.
                    </li>
                    <li>
                        <strong>Komunikacja Drogą Elektroniczną</strong>
                        {' '}
                        – Komunikacja pomiędzy stronami za pośrednictwem poczty elektronicznej (e-mail).
                    </li>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    ...
                    <ul><li>Komentowania wpisów i artykułów</li></ul>
                </li>
                <li>
                    Serwis udostępnia dane kontaktowe w postaci:
                    <ul><li>Adresu e-mail</li></ul>
                </li>
                <li>
                    W przypadku kontaktu Usługobiorcy z Usługodawcą, dane osobowe Usługobiorców będa przetwarzane zgodnie z &quot;
                    <a href="https://zakoduj-to.pl/polityka-prywatnosci/">Polityką Prywatności</a>
            ...
            <p>
                Zakres, cele, sposób oraz zasady przetwarzania danych dostępne są w załącznikach do Regulaminu: &#8222;
                <a href="https://zakoduj-to.pl/obowiazek-informacyjny-rodo/">Obowiązek informacyjny RODO</a>
                &#8221; oraz w &#8222;
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>Wysyłając wiadomość na adres e-mail: al.zakoduj@gmail.com</li>
                        <li>Poprzez połączenie telefoniczne z numerem: </li>
                    </ul>

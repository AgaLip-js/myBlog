...
const RODO = () => (
    <StyledWrapper>
        ...
        {' '}
        <p>Administratorem Danych Osobowych (dalej Administrator) jest firma Agata Lipiak - Zakoduj to, prowadząca działalność w Jędrzychowice 77, 59-900 Zgorzelec, o nadanym numerze identyfikacji podatkowej (NIP): 6152063512, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
        ...
        <ul>
            <li>
                <p>
                    <strong>Adres pocztowy</strong>
                    {' '}
                    - Agata Lipiak, Jędrzychowice 77, 59-900 Zgorzelec
                </p>
            </li>
            {' '}
            <li>
        ...
        <ul>
            <li>
                ...
                <ul><li>Usługi komentowania / polubienia wpisów w Serwisie bez konieczności rejestrowania się</li></ul>
            </li>
        ...
        <p>
            Co do zasady, wskazane dane osobowe są przechowywane wyłącznie przez okres świadczenia usługi w ramach prowadzonego serwisu przez Administratora. Są one usuwane lub anonimizowane w okresie do
        ...
        <p>
            ...
            , chyba że zostały opublikowane na skutek indywidualnego działania Użytkownika (np. wprowadzenie komentarza lub wpisu), co sprawi, że dane będą dostępne dla każdej osoby odwiedzającej serwis.
